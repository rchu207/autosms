...
package tw.idv.rchu.autosms.util;
...
import tw.idv.rchu.autosms.MainUtility;
...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = MainUtility.hasHoneycomb() ? new SerialExecutor() :
